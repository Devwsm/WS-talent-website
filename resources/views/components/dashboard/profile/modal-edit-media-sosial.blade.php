<button command="show-modal" commandfor="updateMediaSosialDialog{{ $item->id_media_sosial }}"
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden transition-all">
                ...
                <div class="bg-blue-950 text-white px-6 py-4">
                    <h3 class="font-bold text-lg">UPDATE MEDIA SOSIAL</h3>
                </div>
                <!-- Form -->
                <form action="{{ route('media_sosial.update', $item->id_media_sosial) }}" method="POST">
                    ...
                    <div class="p-6 flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm uppercase font-semibold">url</label>
                    ...
                    <div class="flex justify-end gap-2 px-6 py-4 bg-gray-100">
                        <button type="button" command="close"
                            commandfor="updateMediaSosialDialog{{ $item->id_media_sosial }}"
