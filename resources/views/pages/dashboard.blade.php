                                ...
                                <div class="grid grid-cols-1 gap-4 p-4 border-2 border-[#5E0006] items-center">
                                    <div class="grid grid-cols-1 gap-4">
                                        ...
                                        <div class="text-center md:text-left">
                                            ...
                                            <h1 class="text-xs md:text-md lg:text-lg font-semibold">{{ $item->banner_name }}</h1>
                                        </div>
                                        <!-- link_banner -->
                                        <div class="text-center md:text-left">
                                            <h1 class="text-xs uppercase text-white/60">link_banner</h1>
                                            <h1 class="text-xs md:text-md lg:text-lg font-semibold">{{ $item->link_banner }}</h1>
                                        </div>
                                        <!-- banner cover -->
                                ...
                                <div class="grid grid-cols-1 gap-4 p-4 border-2 border-[#5E0006] items-center">
                                    <div class="grid grid-cols-1 md:grid-cols-2">
                                        ...
                                        <div class="text-center md:text-left">
                                            ...
                                            <h1 class="text-xs md:text-md lg:text-lg font-semibold">{{ $item->news_source }}
                                            </h1>
                                        </div>
                                        <!-- news_date -->
                                        <div class="text-center md:text-left">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h1 class="text-xs md:text-md lg:text-lg font-semibold">{{ $item->albums_name }}
                                            </h1>
                                        </div>
                                        <!-- link_spotify -->
                                        <div class="text-center">
