                ...
                <form action="{{ route('albums.update', $item->id_albums) }}" method="POST">
                    ...
                    <div class="p-6 flex flex-col gap-4">
                        <div class="flex flex-col gap-2">
                            <label class="text-sm uppercase font-semibold">albums name</label>
                            <input type="text" name="albums_name"
                                value="{{ $item->albums_name }}"
                                class="w-full border p-2 rounded-lg focus:ring-2 focus:ring-blue-800 outline-none">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label class="text-sm uppercase font-semibold">link spotify</label>
                            <input type="text" name="link_spotify"
                                value="{{ $item->link_spotify }}"
                                class="w-full border p-2 rounded-lg focus:ring-2 focus:ring-blue-800 outline-none">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label class="text-sm uppercase font-semibold">albums cover</label>
                            <input type="file" name="albums_cover"
                                value="{{ $item->albums_cover }}"
                                class="w-full border p-2 rounded-lg focus:ring-2 focus:ring-blue-800 outline-none">
                        </div>
                    </div>
                    <!-- Footer -->
