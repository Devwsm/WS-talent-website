<button type="button" onclick="document.getElementById('updateDialog{{ $item->id_news }}').showModal()"
    ...
    <div class="min-h-screen w-full flex items-center justify-center p-4">
        ...
        <div
            ...
            <div class="flex items-center justify-between gap-2 px-6 py-4 border-b border-white/10 bg-white/3 shrink-0">
                ...
                <button type="button" onclick="document.getElementById('updateDialog{{ $item->id_news }}').close()"
            ...
            <form action="{{ route('news.update', $item->id_news) }}" method="POST" enctype="multipart/form-data"
                ...
                <div
                    ...
                    <button type="button"
                        onclick="document.getElementById('updateDialog{{ $item->id_news }}').close()"
