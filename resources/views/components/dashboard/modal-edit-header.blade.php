                    ...
                    <div class="p-6 flex flex-col gap-4 overflow-y-auto">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <textarea name="header_description" rows="3"
                                class="bg-white/5 border border-white/15 text-white placeholder-white/30 p-3 rounded-lg focus:outline-none focus:border-red-900 focus:ring-1 focus:ring-red-900 transition resize-none">{{ $item->header_description }}</textarea>
                        </div>
                            ...
                            @if ($item->header_background)
                                @if ($bgIsVideo)
                                    <video src="{{ Storage::url('header/background/' . $item->header_background) }}"
                                        class="max-h-32 rounded-lg border border-white/10 object-cover mb-1 w-full"
                                        controls muted></video>
                                @else
