<button command="show-modal" commandfor="updateMediaCoverageDialog{{ $item->id_media_coverage }}"
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            ...
            <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden transition-all">
                ...
                <div class="bg-blue-950 text-white px-6 py-4">
                    <h3 class="font-bold text-lg">UPDATE MEDIA COVERAGE</h3>
                </div>
                <!-- Form -->
                <form action="{{ route('media_coverage.update', $item->id_media_coverage) }}" method="POST">
                    ...
                    <div class="p-6 flex flex-col gap-4">
                        <div class="flex flex-col gap-2">
                            <label class="text-sm uppercase font-semibold">nama media</label>
                    ...
                    <div class="flex justify-end gap-2 px-6 py-4 bg-gray-100">
                        <button type="button" command="close"
                            commandfor="updateMediaCoverageDialog{{ $item->id_media_coverage }}"
