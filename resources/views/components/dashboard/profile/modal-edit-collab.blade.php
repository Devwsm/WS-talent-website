<button type="button" onclick="document.getElementById('updateCollabDialog{{ $item->id_collab }}').showModal()"
    ...
    <div class="min-h-screen w-full flex items-center justify-center p-4">
        ...
        <div
            ...
            <div class="flex items-center justify-between gap-2 px-6 py-4 border-b border-white/10 bg-white/3 shrink-0">
                ...
                <button type="button"
                    onclick="document.getElementById('updateCollabDialog{{ $item->id_collab }}').close()"
