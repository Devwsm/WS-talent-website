<button type="button" onclick="document.getElementById('updateBookingDialog{{ $item->id_booking }}').showModal()"
    ...
    <div class="min-h-screen w-full flex items-center justify-center p-4">
        ...
        <div
            ...
            <div class="flex items-center justify-between gap-2 px-6 py-4 border-b border-white/10 bg-white/3 shrink-0">
                <h3 class="font-bold uppercase tracking-wide text-sm text-white">Update Booking & Kontak</h3>
                <button type="button"
                    onclick="document.getElementById('updateBookingDialog{{ $item->id_booking }}').close()"
